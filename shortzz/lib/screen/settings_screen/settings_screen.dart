            ...
            children: [
                  ...
                  return SettingIconTextWithArrow(
                    ...
                    widget: CustomToggle(
                      isOn: (controller.myUser.value
                          ...
                          .obs,
                      onChanged: (value) {
                        controller.onChangedToggle(value,
              ...
              SettingIconTextWithArrow(
                ...
                widget: Obx(() {
                  ...
                  return CustomToggle(
                    isOn: themeController.isDarkMode.obs,
                    onChanged: (val) {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return InkWell(
        onTap: () {
          if (!isVerify) {
            Get.to<bool>(() => SubscriptionScreen(
                    onUpdateUser: widget.onUpdateUser))
                ?.then((value) {
              if (value == true) {
                widget.controller.myUser
                    .update((val) => val?.isVerify = 1);
              }
            });
          }
        },
